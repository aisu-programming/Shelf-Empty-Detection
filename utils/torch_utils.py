...
from Shelf_Empty_Detection.utils.general import LOGGER, check_version, colorstr, file_date, git_describe
...
def reshape_classifier_output(model, n=1000):
    ...
    from Shelf_Empty_Detection.models.common import Classify
